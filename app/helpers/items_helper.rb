module ItemsHelper
	...
	def cover_for item
		image_tag '404cover.jpg', alt: item.pretty_name, class: 'book_cover', width: "200", height: "300"
	end

	def mini_cover_for item
		image_tag '404cover.jpg', alt: item.pretty_name, class: 'book_cover', width: "100", height: "150"
	end
