class EventsController < ApplicationController
  ...
  def discussions
    @events = Event.all.where(activity: "Discussion").paginate(page: params[:page])
    @title = "Discussions"
  ...
  def screenings
    @events = Event.all.where(activity: "Film_screening").paginate(page: params[:page])
  ...
  def pub_meets
    @events = Event.all.where(activity: "Pub_meet").paginate(page: params[:page])
    @title = "Pub meets"
  ...
  def speaker_events
    @events = Event.all.where(activity: "Speaker_event").paginate(page: params[:page])
  ...
  def cinema_trips
    @events = Event.all.where(activity: "Cinema_trip").paginate(page: params[:page])
    @title = "Cinema trips"
  ...
  def games_nights
    @events = Event.all.where(activity: "Games_Night").paginate(page: params[:page])
    @title = "Games Nights"
