class EventsController < ApplicationController
  ...
  def discussions
    @forthcoming_events = Event.all.where(activity: "Discussion").select{ |ev| ev.time>Time.now }.paginate(page: params[:forthcoming_page])
    @past_events = Event.all.where(activity: "Discussion").select{ |ev| ev.time<Time.now }.paginate(page: params[:past_page])
    @title = "Discussions"
  ...
  def speaker_events
    @forthcoming_events = Event.all.where(activity: "Speaker_event").select{ |ev| ev.time>Time.now }.paginate(page: params[:forthcoming_page])
    @past_events = Event.all.where(activity: "Speaker_event").select{ |ev| ev.time<Time.now }.paginate(page: params[:past_page])
  ...
  def cinema_trips
    @forthcoming_events = Event.all.where(activity: "Cinema_trip").select{ |ev| ev.time>Time.now }.paginate(page: params[:forthcoming_page])
    @past_events = Event.all.where(activity: "Cinema_trip").select{ |ev| ev.time<Time.now }.paginate(page: params[:past_page])
    @title = "Cinema trips"
  ...
  def games_nights
    @forthcoming_events = Event.all.where(activity: "Games_Night").select{ |ev| ev.time>Time.now }.paginate(page: params[:forthcoming_page])
    @past_events = Event.all.where(activity: "Games_Night").select{ |ev| ev.time<Time.now }.paginate(page: params[:past_page])
    @title = "Games Nights"
  ...
  private
	  ...
	  def event_params
		params.require(:event).permit(:name, :time, :description, :location, :activity)	  	
	  end
